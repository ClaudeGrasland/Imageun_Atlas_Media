...
We also export in .csv format for people that want to explore result out of R or want to check the quality of tags.

```{r}
td<-tidy(qd)
write_csv2(td,"data/corpus/qd_mycorpus_geo_top.csv" )
```
